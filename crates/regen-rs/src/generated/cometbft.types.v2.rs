...
pub struct SynchronyParams {
    ...
    #[prost(message, optional, tag = "2")]
    pub message_delay: ::core::option::Option<
        ::tendermint_proto::google::protobuf::Duration,
    >,
}
...
pub struct FeatureParams {
    ...
    #[prost(message, optional, tag = "1")]
    pub vote_extensions_enable_height: ::core::option::Option<
        ::tendermint_proto::google::protobuf::Int64Value,
    >,
    ...
    /// Cannot be set to heights lower or equal to the current blockchain height.
    #[prost(message, optional, tag = "2")]
    pub pbts_enable_height: ::core::option::Option<
        ::tendermint_proto::google::protobuf::Int64Value,
    >,
}
